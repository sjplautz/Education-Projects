...
knowledge0 = And(
    ...
    #Aknight -> Statement, Aknave -> ~Statement
...
knowledge2 = And(
    ...
    #puzzle specific knowledge
    Or(And(AKnave, BKnave), Not(And(AKnave, BKnave))),
    Or(And(AKnight, BKnight), Not(And(AKnight, BKnight))),
    Or(And(AKnave, BKnight), Not(And(AKnave, BKnight))),
    Or(And(AKnight, BKnave), Not(And(AKnight, BKnave)))
)
